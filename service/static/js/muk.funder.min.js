...
if(from!==false||to!==false){if(from===to){return from}}var frag="";if(from!==false){frag+=from}else{frag+="< "}if(to!==false){if(from!==false){frag+=" - "+to}else{frag+=to}}else{if(from!==false){frag+="+"}else{frag="unknown"}}return frag}}},newPager:function(params){if(!params){params={}}edges.Pager.prototype=edges.newComponent(params);return new edges.Pager(params)},Pager:function(params){this.defaultRenderer=params.defaultRenderer||"newPagerRenderer";this.from=false;this.to=false;this.total=false;this.page=false;this.pageSize=false;this.totalPages=false;this.synchronise=function(){this.from=false;this.to=false;this.total=false;this.page=false;this.pageSize=false;this.totalPages=false;if(this.edge.currentQuery){this.from=parseInt(this.edge.currentQuery.getFrom())+1;this.pageSize=parseInt(this.edge.currentQuery.getSize())}if(this.edge.result){this.total=this.edge.result.total()}if(this.from!==false&&this.total!==false){this.to=this.from+this.pageSize-1;this.page=Math.ceil((this.from-1)/this.pageSize)+1;this.totalPages=Math.ceil(this.total/this.pageSize)}};this.setFrom=function(from){var nq=this.edge.cloneQuery();from=from-1;if(from<0){from=0}nq.from=from;this.edge.pushQuery(nq);this.edge.doQuery()};this.setSize=function(size){var nq=this.edge.cloneQuery();nq.size=size;this.edge.pushQuery(nq);this.edge.doQuery()};this.decrementPage=function(){var from=this.from-this.pageSize;this.setFrom(from)};this.incrementPage=function(){var from=this.from+this.pageSize;this.setFrom(from)};this.goToPage=function(params){var page=params.page;var nf=(page-1)*this.pageSize+1;this.setFrom(nf)}},newSearchingNotification:function(params){if(!params){params={}}edges.SearchingNotification.prototype=edges.newComponent(params);return new edges.SearchingNotification(params)},SearchingNotification:function(params){this.defaultRenderer=params.defaultRenderer||"newSearchingNotificationRenderer";this.searching=false;this.init=function(edge){Object.getPrototypeOf(this).init.call(this,edge);edge.context.on("edges:pre-query",edges.eventClosure(this,"searchingBegan"));edge.context.on("edges:query-fail",edges.eventClosure(this,"searchingFinished"));edge.context.on("edges:query-success",edges.eventClosure(this,"searchingFinished"))};this.draw=function(){};this.searchingBegan=function(){this.searching=true;this.renderer.draw()};this.searchingFinished=function(){this.searching=false;this.renderer.draw()}},newResultsDisplay:function(params){if(!params){params={}}edges.ResultsDisplay.prototype=edges.newComponent(params);return new edges.ResultsDisplay(params)},ResultsDisplay:function(params){this.category=params.category||"results";this.defaultRenderer=params.defaultRenderer||"newResultsDisplayRenderer";this.results=false;this.synchronise=function(){this.results=[];if(this.edge.result){this.results=this.edge.result.results()}}}});$.extend(edges,{newChart:function(params){if(!params){params={}}edges.Chart.prototype=edges.newComponent(params);return new edges.Chart(params)},Chart:function(params){this.category=params.category||"chart";this.display=params.display||"";this.dataSeries=params.dataSeries||false;this.dataFunction=params.dataFunction||false;this.dataFunctionClosure=params.dataFunctionClosure||false;this.aggregations=params.aggregations||[];this.dfArgs=params.dfArgs||{useAggregations:[],seriesKeys:{}};this.defaultRenderer=params.defaultRenderer||"newMultibarRenderer";this.init=function(edge){edges.newComponent().init.call(this,edge);for(var i=0;i<this.aggregations.length;i++){var agg=this.aggregations[i];if($.inArray(agg.name,this.dfArgs.useAggregations)===-1){this.dfArgs.useAggregations.push(agg.name)}}if(this.aggregations.length>0&&this.dataFunctionClosure){this.dataFunction=this.dataFunctionClosure(this.dfArgs)}};this.contrib=function(query){for(var i=0;i<this.aggregations.length;i++){query.addAggregation(this.aggregations[i])}};this.synchronise=function(){if(this.dataFunction){this.dataSeries=this.dataFunction(this)}}},ChartDataFunctions:{terms:function(params){var useAggregations=params.useAggregations||[];var seriesKeys=params.seriesKeys||{};return function(ch){var data_series=[];if(!ch.edge.result){return data_series}for(var i=0;i<useAggregations.length;i++){var agg=useAggregations[i];var buckets=ch.edge.result.data.aggregations[agg].buckets;var series={};series["key"]=seriesKeys[agg];series["values"]=[];for(var j=0;j<buckets.length;j++){var doccount=buckets[j].doc_count;var key=buckets[j].key;series.values.push({label:key,value:doccount})}data_series.push(series)}return data_series}},termsStats:function(params){var useAggregations=params.useAggregations||[];var seriesKeys=params.seriesKeys||{};var seriesFor=params.seriesFor||[];return function(ch){var data_series=[];if(!ch.edge.result){return data_series}for(var i=0;i<useAggregations.length;i++){var agg=useAggregations[i];var parts=agg.split(" ");for(var j=0;j<seriesFor.length;j++){var seriesStat=seriesFor[j];var series={};series["key"]=seriesKeys[agg+" "+seriesStat];series["values"]=[];var buckets=ch.edge.result.data.aggregations[parts[0]].buckets;for(var k=0;k<buckets.length;k++){var stats=buckets[k][parts[1]];var key=buckets[k].key;var val=stats[seriesStat];series.values.push({label:key,value:val})}data_series.push(series)}}return data_series}},recordsXY:function(params){var x=params.x;var x_default=params.x_default===undefined?0:params.x_default;var y=params.y;var y_default=params.y_default===undefined?0:params.y_default;var key=params.key;return function(ch){var data_series=[];if(!ch.edge.result){return data_series}var series={};series["key"]=key;series["values"]=[];var results=ch.edge.result.results();for(var i=0;i<results.length;i++){var res=results[i];var xval=edges.objVal(x,res,x_default);var yval=edges.objVal(y,res,y_default);series.values.push({label:xval,value:yval})}data_series.push(series);return data_series}},cumulativeXY:function(params){var x=params.x;var x_default=params.x_default===undefined?0:params.x_default;var y=params.y;var y_default=params.y_default===undefined?0:params.y_default;var key=params.key;var accumulate=params.accumulate||"y";return function(ch){var data_series=[];if(!ch.edge.result){return data_series}var series={};series["key"]=key;series["values"]=[];var total=0;var results=ch.edge.result.results();for(var i=0;i<results.length;i++){var res=results[i];var xval=edges.objVal(x,res,x_default);var yval=edges.objVal(y,res,y_default);if(accumulate==="x"){total+=xval;series.values.push({label:total,value:yval})}else if(accumulate==="y"){total+=yval;series.values.push({label:xval,value:total})}}data_series.push(series);return data_series}},totalledList:function(params){var listPath=params.listPath||"";var seriesKey=params.seriesKey||"";var keyField=params.keyField||false;var valueField=params.valueField||false;return function(ch){var data_series=[];if(!ch.edge.result){return data_series}var series={};series["key"]=seriesKey;series["values"]=[];var counter={};var results=ch.edge.result.results();for(var i=0;i<results.length;i++){var res=results[i];var l=edges.objVal(listPath,res,[]);for(var j=0;j<l.length;j++){var lo=l[j];var key=edges.objVal(keyField,lo,false);var value=edges.objVal(valueField,lo,0);if(key in counter){counter[key]+=value}else{counter[key]=value}}}for(key in counter){var val=counter[key];series.values.push({label:key,value:val})}data_series.push(series);return data_series}}},newPieChart:function(params){if(!params){params={}}edges.PieChart.prototype=edges.newChart(params);return new edges.PieChart(params)},PieChart:function(params){this.defaultRenderer=params.defaultRenderer||"newPieChartRenderer"},newHorizontalMultibar:function(params){if(!params){params={}}edges.HorizontalMultibar.prototype=edges.newChart(params);return new edges.HorizontalMultibar(params)},HorizontalMultibar:function(params){this.defaultRenderer=params.defaultRenderer||"newHorizontalMultibarRenderer"},newMultibar:function(params){if(!params){params={}}edges.Multibar.prototype=edges.newChart(params);return new edges.Multibar(params)},Multibar:function(params){this.defaultRenderer=params.defaultRenderer||"newMultibarRenderer"},newSimpleLineChart:function(params){if(!params){params={}}edges.SimpleLineChart.prototype=edges.newChart(params);return new edges.SimpleLineChart(params)},SimpleLineChart:function(params){this.xAxisLabel=params.xAxisLabel||"";this.yAxisLabel=params.yAxisLabel||"";this.defaultRenderer=params.defaultRenderer||"newSimpleLineChartRenderer"},newChartsTable:function(params){if(!params){params={}}edges.ChartsTable.prototype=edges.newComponent(params);return new edges.ChartsTable(params)},ChartsTable:function(params){this.chartComponents=edges.getParam(params.chartComponents,false);this.tabularise=edges.getParam(params.tabularise,false);this.defaultRenderer=params.defaultRenderer||"newChartsTableRenderer";this.results=[];this.synchronise=function(){this.results=[];if(!this.chartComponents){return}var comps=[];for(var i=0;i<this.edge.components.length;i++){var comp=this.edge.components[i];if($.inArray(comp.id,this.chartComponents)>-1){comps.push(comp)}}if(this.tabularise){this.results=this.tabularise(comps)}}}});$.extend(edges,{newRefiningANDTermSelector:function(params){if(!params){params={}}edges.RefiningANDTermSelector.prototype=edges.newSelector(params);return new edges.RefiningANDTermSelector(params)},RefiningANDTermSelector:function(params){this.size=params.size||10;this.orderBy=params.orderBy||"count";this.orderDir=params.orderDir||"desc";this.deactivateThreshold=params.deactivateThreshold||false;this.ignoreEmptyString=params.ignoreEmptyString||true;this.excludePreDefinedFilters=params.excludePreDefinedFilters||true;this.valueMap=params.valueMap||false;this.valueFunction=params.valueFunction||false;this.inflation=params.inflation||100;this.defaultRenderer=params.defaultRenderer||"newRefiningANDTermSelectorRenderer";this.filters=[];this.values=false;this.contrib=function(query){var params={name:this.id,field:this.field,orderBy:this.orderBy,orderDir:this.orderDir};if(this.size){params["size"]=this.size}query.addAggregation(es.newTermsAggregation(params))};this.synchronise=function(){this.values=[];this.filters=[];if(this.edge.result){var buckets=this.edge.result.buckets(this.id);if(buckets.length<this.deactivateThreshold){this.active=false}else{this.active=true}var predefined=[];if(this.excludePreDefinedFilters&&this.edge.baseQuery){predefined=this.edge.baseQuery.listMust(es.TermFilter({field:this.field}))}var realCount=0;for(var i=0;i<buckets.length;i++){var bucket=buckets[i];if(this.ignoreEmptyString&&bucket.key===""){continue}if(this.excludePreDefinedFilters){var exclude=false;for(var j=0;j<predefined.length;j++){var f=predefined[j];if(bucket.key===f.value){exclude=true;break}}if(exclude){continue}}realCount++;if(realCount>this.size){break}var key=this._translate(bucket.key);var obj={display:key,term:bucket.key,count:bucket.doc_count};this.values.push(obj)}}var filters=this.edge.currentQuery.listMust(es.newTermFilter({field:this.field}));for(var i=0;i<filters.length;i++){var val=filters[i].value;val=this._translate(val);this.filters.push({display:val,term:filters[i].value})}};this.selectTerm=function(term){var nq=this.edge.cloneQuery();var removeCount=nq.removeMust(es.newTermFilter({field:this.field,value:term}));if(removeCount>0){return false}nq.addMust(es.newTermFilter({field:this.field,value:term}));nq.from=0;this.edge.pushQuery(nq);this.edge.doQuery();return true};this.removeFilter=function(term){var nq=this.edge.cloneQuery();nq.removeMust(es.newTermFilter({field:this.field,value:term}));nq.from=0;this.edge.pushQuery(nq);this.edge.doQuery()};this.changeSize=function(newSize){this.size=newSize;var nq=this.edge.cloneQuery();var agg=nq.getAggregation({name:this.id});agg.size=this.size;this.edge.pushQuery(nq);this.edge.doQuery()};this.changeSort=function(orderBy,orderDir){this.orderBy=orderBy;this.orderDir=orderDir;var nq=this.edge.cloneQuery();var agg=nq.getAggregation({name:this.id});agg.setOrdering(this.orderBy,this.orderDir);this.edge.pushQuery(nq);this.edge.doQuery()};this._translate=function(term){if(this.valueMap){if(term in this.valueMap){return this.valueMap[term]}}else if(this.valueFunction){return this.valueFunction(term)}return term}},newORTermSelector:function(params){if(!params){params={}}edges.ORTermSelector.prototype=edges.newSelector(params);return new edges.ORTermSelector(params)},ORTermSelector:function(params){this.lifecycle=edges.getParam(params.lifecycle,"static");this.orderBy=edges.getParam(params.orderBy,"term");this.orderDir=edges.getParam(params.orderDir,"asc");this.size=edges.getParam(params.size,10);this.valueMap=edges.getParam(params.valueMap,false);this.valueFunction=edges.getParam(params.valueFunction,false);this.defaultRenderer=edges.getParam(params.defaultRenderer,"newORTermSelectorRenderer");this.terms=edges.getParam(params.terms,false);this.selected=[];this.updating=false;this.init=function(edge){edges.newSelector().init.call(this,edge);if(!this.terms){this.listAll()}};this.synchronise=function(){this.selected=[];var filters=this.edge.currentQuery.listMust(es.newTermsFilter({field:this.field}));for(var i=0;i<filters.length;i++){for(var j=0;j<filters[i].values.length;j++){var val=filters[i].values[j];this.selected.push(val)}}};this.listAll=function(){var bq=this.edge.cloneBaseQuery();bq.clearAggregations();bq.size=0;var params={name:this.id,field:this.field,orderBy:this.orderBy,orderDir:this.orderDir,size:this.size};bq.addAggregation(es.newTermsAggregation(params));es.doQuery({search_url:this.edge.search_url,queryobj:bq.objectify(),datatype:this.edge.datatype,success:edges.objClosure(this,"listAllQuerySuccess",["result"]),error:edges.objClosure(this,"listAllQueryFail")})};this.listAllQuerySuccess=function(params){var result=params.result;this.terms=[];var buckets=result.buckets(this.id);for(var i=0;i<buckets.length;i++){var bucket=buckets[i];this.terms.push({term:bucket.key,display:this._translate(bucket.key),count:bucket.doc_count})}this.setupEvent();this.draw()};this.listAllQueryFail=function(){this.terms=[]};this.setupEvent=function(){if(this.lifecycle==="update"){this.edge.context.on("edges:pre-query",edges.eventClosure(this,"doUpdate"))}};this.doUpdate=function(){if(this.updating){return}this.udpating=true;var bq=this.edge.cloneQuery();bq.removeMust(es.newTermsFilter({field:this.field}));bq.clearAggregations();bq.size=0;var params={name:this.id,field:this.field,orderBy:this.orderBy,orderDir:this.orderDir,size:this.size};bq.addAggregation(es.newTermsAggregation(params));es.doQuery({search_url:this.edge.search_url,queryobj:bq.objectify(),datatype:this.edge.datatype,success:edges.objClosure(this,"doUpdateQuerySuccess",["result"]),error:edges.objClosure(this,"doUpdateQueryFail")})};this.doUpdateQuerySuccess=function(params){var result=params.result;var buckets=result.buckets(this.id);for(var i=0;i<this.terms.length;i++){var t=this.terms[i];var found=false;for(var j=0;j<buckets.length;j++){var b=buckets[j];if(t.term===b.key){t.count=b.doc_count;found=true;break}}if(!found){t.count=0}}this.updating=false;this.draw()};this.doUpdateQueryFail=function(){};this.selectTerms=function(params){var terms=params.terms;var clearOthers=edges.getParam(params.clearOthers,false);var nq=this.edge.cloneQuery();var filters=nq.listMust(es.newTermsFilter({field:this.field}));if(filters.length>0){var filter=filters[0];if(clearOthers){filter.clear_terms()}var hadTermAlready=0;for(var i=0;i<terms.length;i++){var term=terms[i];if(filter.has_term(term)){hadTermAlready++}else{filter.add_term(term)}}if(filter.has_terms()&&hadTermAlready==terms.length){return false}else if(!filter.has_terms()){nq.removeMust(es.newTermsFilter({field:this.field}))}}else{nq.addMust(es.newTermsFilter({field:this.field,values:terms}))}nq.from=0;this.edge.pushQuery(nq);this.edge.doQuery();return true};this.selectTerm=function(term){return this.selectTerms({terms:[term]})};this.removeFilter=function(term){var nq=this.edge.cloneQuery();var filters=nq.listMust(es.newTermsFilter({field:this.field}));if(filters.length>0){var filter=filters[0];if(filter.has_term(term)){filter.remove_term(term)}if(!filter.has_terms()){nq.removeMust(es.newTermsFilter({field:this.field}))}}nq.from=0;this.edge.pushQuery(nq);this.edge.doQuery()};this._translate=function(term){if(this.valueMap){if(term in this.valueMap){return this.valueMap[term]}}else if(this.valueFunction){return this.valueFunction(term)}return term}},newBasicRangeSelector:function(params){if(!params){params={}}edges.BasicRangeSelector.prototype=edges.newSelector(params);return new edges.BasicRangeSelector(params)},BasicRangeSelector:function(params){this.ranges=params.ranges||[];this.formatUnknown=params.formatUnknown||false;this.defaultRenderer=params.defaultRenderer||"newBasicRangeSelectorRenderer";this.values=[];this.filters=[];this.contrib=function(query){var ranges=[];for(var i=0;i<this.ranges.length;i++){var r=this.ranges[i];var obj={};if(r.from){obj.from=r.from}if(r.to){obj.to=r.to}ranges.push(obj)}query.addAggregation(es.newRangeAggregation({name:this.id,field:this.field,ranges:ranges}))};this.synchronise=function(){this.values=[];this.filters=[];if(this.edge.result){var buckets=this.edge.result.buckets(this.id);for(var i=0;i<this.ranges.length;i++){var r=this.ranges[i];var bucket=this._getRangeBucket(buckets,r.from,r.to);var obj=$.extend(true,{},r);obj["count"]=bucket.doc_count;this.values.push(obj)}}if(this.edge.currentQuery){var filters=this.edge.currentQuery.listMust(es.newRangeFilter({field:this.field}));for(var i=0;i<filters.length;i++){var to=filters[i].lt;var from=filters[i].gte;var r=this._getRangeDef(from,to);if(r){this.filters.push(r)}else{this.filters.push({display:this._formatUnknown(from,to),from:from,to:to})}}}};this.selectRange=function(from,to){var nq=this.edge.cloneQuery();var params={field:this.field};if(from){params["gte"]=from}if(to){params["lt"]=to}nq.addMust(es.newRangeFilter(params));nq.from=0;this.edge.pushQuery(nq);this.edge.doQuery()};this.removeFilter=function(from,to){var nq=this.edge.cloneQuery();var params={field:this.field};if(from){params["gte"]=from}if(to){params["lt"]=to}nq.removeMust(es.newRangeFilter(params));nq.from=0;this.edge.pushQuery(nq);this.edge.doQuery()};this._getRangeDef=function(from,to){for(var i=0;i<this.ranges.length;i++){var r=this.ranges[i];var frMatch=true;var toMatch=true;if(from&&!r.from||!from&&r.from){frMatch=false}if(to&&!r.to||!to&&r.to){toMatch=false}if(from&&r.from&&from!==r.from){frMatch=false}if(to&&r.to&&to!==r.to){toMatch=false}if(frMatch&&toMatch){return r}}return false};this._getRangeBucket=function(buckets,from,to){for(var i=0;i<buckets.length;i++){var r=buckets[i];var frMatch=true;var toMatch=true;if(from&&!r.from||!from&&r.from){frMatch=false}if(to&&!r.to||!to&&r.to){toMatch=false}if(from&&r.from&&from!==r.from){frMatch=false}if(to&&r.to&&to!==r.to){toMatch=false}if(frMatch&&toMatch){return r}}return false};this._formatUnknown=function(from,to){if(this.formatUnknown){return this.formatUnknown(from,to)}else{var frag="";if(from){frag+=from}else{frag+="< "}if(to){if(from){frag+=" - "+to}else{frag+=to}}else{if(from){frag+="+"}else{frag="unknown"}}return frag}}},newBasicGeoDistanceRangeSelector:function(params){if(!params){params={}}edges.BasicGeoDistanceRangeSelector.prototype=edges.newSelector(params);return new edges.BasicGeoDistanceRangeSelector(params)},BasicGeoDistanceRangeSelector:function(params){this.distances=params.distances||[];this.hideEmptyDistance=params.hideEmptyDistance||true;this.unit=params.unit||"m";this.lat=params.lat||false;this.lon=params.lon||false;this.values=[];this.synchronise=function(){this.values=[]}},newDateHistogramSelector:function(params){if(!params){params={}}edges.BasicRangeSelector.prototype=edges.newSelector(params);return new edges.BasicRangeSelector(params)},DateHistogramSelector:function(params){this.interval=params.interval||"year";this.sort=params.sort||"asc";this.hideEmptyDateBin=params.hideEmptyDateBin||true;this.shortDisplay=params.shortDisplay||false;this.values=[];this.synchronise=function(){this.values=[]}},newAutocompleteTermSelector:function(params){if(!params){params={}}edges.AutocompleteTermSelector.prototype=edges.newComponent(params);return new edges.AutocompleteTermSelector(params)},AutocompleteTermSelector:function(params){this.defaultRenderer=params.defaultRenderer||"newAutocompleteTermSelectorRenderer"}});$.extend(true,edges,{bs3:{newORTermSelectorRenderer:function(params){if(!params){params={}}edges.bs3.ORTermSelectorRenderer.prototype=edges.newRenderer(params);return new edges.bs3.ORTermSelectorRenderer(params)},ORTermSelectorRenderer:function(params){this.open=edges.getParam(params.open,false);this.togglable=edges.getParam(params.togglable,true);this.showCount=edges.getParam(params.showCount,false);this.hideEmpty=edges.getParam(params.hideEmpty,false);this.openIcon=edges.getParam(params.openIcon,"glyphicon glyphicon-plus");this.closeIcon=edges.getParam(params.closeIcon,"glyphicon glyphicon-minus");this.layout=edges.getParam(params.layout,"left");this.namespace="edges-bs3-or-term-selector";this.draw=function(){var ts=this.component;var namespace=this.namespace;var resultClass=edges.css_classes(namespace,"result",this);var valClass=edges.css_classes(namespace,"value",this);var filterRemoveClass=edges.css_classes(namespace,"filter-remove",this);var facetClass=edges.css_classes(namespace,"facet",this);var headerClass=edges.css_classes(namespace,"header",this);var selectionsClass=edges.css_classes(namespace,"selections",this);var bodyClass=edges.css_classes(namespace,"body",this);var countClass=edges.css_classes(namespace,"count",this);var toggleId=edges.css_id(namespace,"toggle",this);var resultsId=edges.css_id(namespace,"results",this);var results="Loading...";if(ts.terms.length>0){results="";for(var i=0;i<ts.terms.length;i++){var val=ts.terms[i];if(val.count===0&&this.hideEmpty){continue}if($.inArray(val.term.toString(),ts.selected)===-1){results+='<div class="'+resultClass+'"><a href="#" class="'+valClass+'" data-key="'+edges.escapeHtml(val.term)+'">'+edges.escapeHtml(val.display)+"</a>";if(this.showCount){results+=' <span class="'+countClass+'">('+val.count+")</span>"}results+="</div>"}}}var filterFrag="";if(ts.selected.length>0){for(var i=0;i<ts.selected.length;i++){var filt=ts.selected[i];var def=this._getFilterDef(filt);if(def){filterFrag+='<div class="'+resultClass+'"><strong>'+edges.escapeHtml(def.display);if(this.showCount){filterFrag+=" ("+def.count+")"}filterFrag+='&nbsp;<a href="#" class="'+filterRemoveClass+'" data-key="'+edges.escapeHtml(def.term)+'">';filterFrag+='<i class="glyphicon glyphicon-black glyphicon-remove"></i></a>';filterFrag+="</strong></a></div>"}}}var header=this.headerLayout({toggleId:toggleId});var frag='<div class="'+facetClass+'">                        <div class="'+headerClass+'"><div class="row">                             <div class="col-md-12">                                '+header+'                            </div>                        </div></div>                        <div class="'+bodyClass+'">                            <div class="row" style="display:none" id="'+resultsId+'">                                <div class="col-md-12">                                    {{SELECTED}}                                </div>                                <div class="col-md-12"><div class="'+selectionsClass+'">                                    {{RESULTS}}                                </div>                            </div>                        </div>                        </div></div>';frag=frag.replace(/{{RESULTS}}/g,results).replace(/{{SELECTED}}/g,filterFrag);ts.context.html(frag);this.setUIOpen();var valueSelector=edges.css_class_selector(namespace,"value",this);var filterRemoveSelector=edges.css_class_selector(namespace,"filter-remove",this);var toggleSelector=edges.css_id_selector(namespace,"toggle",this);edges.on(valueSelector,"click",this,"termSelected");edges.on(toggleSelector,"click",this,"toggleOpen");edges.on(filterRemoveSelector,"click",this,"removeFilter")};this.headerLayout=function(params){var toggleId=params.toggleId;var iconClass=edges.css_classes(this.namespace,"icon",this);if(this.layout==="left"){var tog=this.component.display;if(this.togglable){tog='<a href="#" id="'+toggleId+'"><i class="'+this.openIcon+'"></i>&nbsp;'+tog+"</a>"}return tog}else if(this.layout==="right"){var tog="";if(this.togglable){tog='<a href="#" id="'+toggleId+'">'+this.component.display+'&nbsp;<i class="'+this.openIcon+" "+iconClass+'"></i></a>'}else{tog=this.component.display}return tog}};this.setUIOpen=function(){var resultsSelector=edges.css_id_selector(this.namespace,"results",this);var toggleSelector=edges.css_id_selector(this.namespace,"toggle",this);var results=this.component.jq(resultsSelector);var toggle=this.component.jq(toggleSelector);var openBits=this.openIcon.split(" ");var closeBits=this.closeIcon.split(" ");if(this.open){var i=toggle.find("i");for(var j=0;j<openBits.length;j++){i.removeClass(openBits[j])}for(var j=0;j<closeBits.length;j++){i.addClass(closeBits[j])}results.show()}else{var i=toggle.find("i");for(var j=0;j<closeBits.length;j++){i.removeClass(closeBits[j])}for(var j=0;j<openBits.length;j++){i.addClass(openBits[j])}results.hide()}};this.termSelected=function(element){var term=this.component.jq(element).attr("data-key");this.component.selectTerm(term)};this.removeFilter=function(element){var term=this.component.jq(element).attr("data-key");this.component.removeFilter(term)};this.toggleOpen=function(element){this.open=!this.open;this.setUIOpen()};this._getFilterDef=function(term){for(var i=0;i<this.component.terms.length;i++){var t=this.component.terms[i];if(term===t.term){return t}}return false}}}});$.extend(true,edges,{bs3:{newNSeparateORTermSelectorRenderer:function(params){if(!params){params={}}edges.bs3.NSeparateORTermSelectorRenderer.prototype=edges.newRenderer(params);return new edges.bs3.NSeparateORTermSelectorRenderer(params)},NSeparateORTermSelectorRenderer:function(params){this.n=edges.getParam(params.n,1);this.colMdWidth=edges.getParam(params.colMdWidth,3);this.properties=edges.getParam(params.properties,[]);this.showCount=edges.getParam(params.showCount,false);this.hideEmpty=edges.getParam(params.hideEmpty,false);this.select2=edges.getParam(params.select2,false);this.namespace="edges-bs3-n-separate-or-term-selector";this.draw=function(){var ts=this.component;var selectClass=edges.css_classes(this.namespace,"select",this);var labelClass=edges.css_classes(this.namespace,"label",this);var containerClass=edges.css_classes(this.namespace,"container",this);var selectorFrag='<div class="row">';for(var j=0;j<this.n;j++){var label=false;var unselected="Select an option";if(this.properties.length>j){var prop=this.properties[j];if(prop.label){label=prop.label}if(prop.unselected){unselected=prop.unselected}}var selectId=edges.css_id(this.namespace,"select-"+j,this);var options="";if(ts.terms.length>0){options+='<option value="">'+edges.escapeHtml(unselected)+"</option>";for(var i=0;i<ts.terms.length;i++){var val=ts.terms[i];if(val.count===0&&this.hideEmpty){continue}options+='<option value="'+edges.escapeHtml(val.term)+'">'+edges.escapeHtml(val.display);if(this.showCount){options+=" ("+val.count+")"}options+="</option>"}}else{options="<option>Loading...</option>"}selectorFrag+='<div class="col-md-'+this.colMdWidth+'"><div class="form-group">                         <label class="'+labelClass+'" for="'+selectId+'">'+edges.escapeHtml(label)+'</label><br>                        <select id="'+selectId+'" name="'+selectId+'" class="'+selectClass+' form-control">'+options+"</select>                     </div></div>"}selectorFrag+="</div>";var frag='<div class="'+containerClass+'"><div class="form-inline">'+selectorFrag+"</div></div>";ts.context.html(frag);var selectSelector=edges.css_class_selector(this.namespace,"select",this);if(this.select2){var jq=this.component.jq(selectSelector);jq.select2()}this._setSelectors();edges.on(selectSelector,"change",this,"selectorChanged")};this.selectorChanged=function(element){var vals=[];for(var i=0;i<this.n;i++){var idSelector=edges.css_id_selector(this.namespace,"select-"+i,this);var element=this.component.jq(idSelector);var val=this._getVal({element:element});if(val&&val!=""){vals.push(val)}}var triggered=this.component.selectTerms({terms:vals,clearOthers:true});if(!triggered){this._setSelectors()}};this._setSelectors=function(){var terms=this.component.selected;for(var i=0;i<this.n;i++){var selected=false;var idSelector=edges.css_id_selector(this.namespace,"select-"+i,this);var element=this.component.jq(idSelector);if(terms.length>i){selected=terms[i];this._setVal({element:element,value:selected})}for(var j=0;j<terms.length;j++){if(terms[j]!==selected){element.find("option[value='"+terms[j]+"']").remove()}}}};this._setVal=function(params){var el=params.element;var value=params.value;if(!this.select2){el.val(value)}else{el.select2("val",value)}};this._getVal=function(params){var el=params.element;if(!this.select2){return el.val()}else{return el.select2("val")}}}}});$.extend(edges,{csv:{serialise:function(params){var json=params.data;return Papa.unparse(json,{newline:"\n"})},newObjectByRow:function(params){if(!params){params={}}return new edges.csv.ObjectByRow(params)},ObjectByRow:function(params){this.sheet=false;this.filters=[];this.parse=function(params){var data=params.data.replace(/\r\n/g,"\n");this.sheet=Papa.parse(data,{header:true,newline:"\n",skipEmptyLines:true})};this.add_filter=function(params){var filter=params.filter;this.filters.push(filter)};this.clear_filter=function(params){var filter=params.filter;var remove=false;for(var i=0;i<this.filters.length;i++){var filt=this.filters[i];var field_match=filter.field===filt.field;var type_match=filter.type===filt.type||filter.type===undefined;var val_match=filter.value===undefined||filter.value.toString()===filt.value.toString();if(field_match&&type_match&&val_match){remove=i;break}}if(remove!==false){this.filters.splice(remove,1)}};this.iterator=function(params){if(!params){params={}}var filtered=edges.getParam(params.filtered,true);var count=0;var that=this;return{next:function(){if(that.sheet.data.length<=count){return false}for(var i=count;i<that.sheet.data.length;i++){var ret=that.sheet.data[i];var match=false;if(!filtered){match=true}else{match=that._filterMatch({record:ret})}if(match){count=i+1;return ret}}return false}}};this.aggregation=function(params){var agg=params.agg;var type=Object.keys(agg)[0];var field=agg[type];var filtered=edges.getParam(params.filtered,true);if(type==="terms"){return this._termsAggregation({field:field,filtered:filtered})}return[]};this._termsAggregation=function(params){var field=params.field;var filtered=edges.getParam(params.filtered,true);var agg=[];var aggMap={};var iter=this.iterator({filtered:filtered});var res=iter.next();while(res){if(res.hasOwnProperty(field)){var val=res[field];if(val in aggMap){agg[aggMap[val]].count++}else{var i=agg.length;agg.push({term:val,count:1});aggMap[val]=i}}res=iter.next()}return agg};this._filterMatch=function(params){var record=params.record;for(var i=0;i<this.filters.length;i++){var filter=this.filters[i];if(filter.type==="exact"){if(!this._exactFilterMatch({filter:filter,record:record})){return false}}else{return false}}return true};this._exactFilterMatch=function(params){var filter=params.filter;var record=params.record;var field=filter.field;var val=filter.value;if(record[field]!==val){return false}return true};this.parse(params)}}});$.extend(true,edges,{bs3:{newTabularResultsRenderer:function(params){if(!params){params={}}edges.bs3.TabularResultsRenderer.prototype=edges.newRenderer(params);return new edges.bs3.TabularResultsRenderer(params)},TabularResultsRenderer:function(params){this.noResultsText=params.noResultsText||"No results to display";this.defaultCellContent=params.defaultCellContent||"-";this.fieldDisplay=params.fieldDisplay||[];
this.displayListedOnly=edges.getParam(params.displayListedOnly,true);this.headerOrderingFunction=edges.getParam(params.headerOrderingFunction,false);this.download=edges.getParam(params.download,false);this.downloadText=edges.getParam(params.downloadText,"download");this.downloadPrefix=edges.getParam(params.downloadPrefix,"download");this.namespace="edges-bs3-tabular-results";this.draw=function(){var frag=this.noResultsText;if(this.component.results===false){frag=""}var results=this.component.results;if(results&&results.length>0){var headerKeys=this._getHeaderRow();var tableClasses=edges.css_classes(this.namespace,"table",this);var headerClasses=edges.css_classes(this.namespace,"header",this);var cellClasses=edges.css_classes(this.namespace,"cell",this);var downloadClasses=edges.css_classes(this.namespace,"download",this);var tableDivClasses=edges.css_classes(this.namespace,"tablediv",this);var downloadId=edges.css_id(this.namespace,"download",this);var down="";if(this.download){down='<div class="row"><div class="col-md-12"><div class="'+downloadClasses+'"><a href="#" id="'+downloadId+'">'+edges.escapeHtml(this.downloadText)+"</a></div></div></div>"}var frag='<div class="table-responsive '+tableDivClasses+'">';frag+='<table class="'+tableClasses+'"><thead><tr>_HEADERS_</tr></thead><tbody>';var headerDisplay=[];for(var i=0;i<headerKeys.length;i++){var trip=false;for(var j=0;j<this.fieldDisplay.length;j++){var fd=this._getFieldDisplay(headerKeys[i]);if(fd){headerDisplay.push(fd.display);trip=true;break}}if(!trip){headerDisplay.push(headerKeys[i])}}var headers="";for(var i=0;i<headerDisplay.length;i++){var header=headerDisplay[i];headers+='<th class="'+headerClasses+'">'+header+"</th>"}frag=frag.replace(/_HEADERS_/g,headers);for(var i=0;i<results.length;i++){var res=results[i];frag+="<tr>";for(var j=0;j<headerKeys.length;j++){var key=headerKeys[j];var def=this.defaultCellContent;var fd=this._getFieldDisplay(key);if(fd){def=fd.default}var val=edges.objVal(key,res,def);var fieldClasses=edges.css_classes(this.namespace,"cell-"+edges.safeId(key),this);frag+='<td class="'+cellClasses+" "+fieldClasses+'">'+edges.escapeHtml(val)+"</td>"}frag+="</tr>"}frag+="</tbody></table></div>"+down}this.component.context.html(frag);if(this.download){var downloadIdSelector=edges.css_id_selector(this.namespace,"download",this);edges.on(downloadIdSelector,"click",this,"doDownload")}};this.doDownload=function(element){if(!this.download){return}var downloadInfo=this._downloadData();var blob=new Blob([downloadInfo.data],{type:downloadInfo.fileType});var url=window.URL.createObjectURL(blob);var a=document.createElement("a");document.body.appendChild(a);a.style="display: none";a.href=url;a.download=downloadInfo.fileName;a.click();window.URL.revokeObjectURL(url)};this._downloadData=function(){if(!this.download){return false}var table=[];var results=this.component.results;if(results&&results.length>0){var headerKeys=this._getHeaderRow();var headerDisplay=[];for(var i=0;i<headerKeys.length;i++){var trip=false;for(var j=0;j<this.fieldDisplay.length;j++){var fd=this._getFieldDisplay(headerKeys[i]);if(fd){headerDisplay.push(fd.display);trip=true;break}}if(!trip){headerDisplay.push(headerKeys[i])}}table.push(headerDisplay);for(var i=0;i<results.length;i++){var res=results[i];var row=[];for(var j=0;j<headerKeys.length;j++){var key=headerKeys[j];var val=edges.objVal(key,res,"");row.push(val)}table.push(row)}}var data=edges.csv.serialise({data:table});var fileType="text/csv;charset=UTF-8";var extension="csv";var stamp=(new Date).getTime();var fileName=this.downloadPrefix+"_"+stamp+"."+extension;return{data:data,fileType:fileType,fileName:fileName}};this._getFieldDisplay=function(field){for(var j=0;j<this.fieldDisplay.length;j++){if(this.fieldDisplay[j].field==field){return this.fieldDisplay[j]}}return false};this._getHeaderRow=function(){if(this.headerOrderingFunction){return this.headerOrderingFunction(this)}var results=this.component.results;var hasResults=results!==false&&results.length>0;if(!hasResults||this.fieldDisplay.length==0&&this.displayListedOnly){return[]}var headers=[];if(this.fieldDisplay.length>0){for(var i=0;i<this.fieldDisplay.length;i++){headers.push(this.fieldDisplay[i].field)}}if(!this.displayListedOnly){var keySet={};for(var i=0;i<results.length;i++){var ks=Object.keys(results[i]);for(var j=0;j<ks.length;j++){if(!(ks[j]in keySet)){keySet[ks[j]]=true}}}var keys=Object.keys(keySet);keys.sort();for(var i=0;i<keys.length;i++){if($.inArray(keys[i],headers)==-1){headers.push(keys[i])}}}return headers}}}});$.extend(true,edges,{bs3:{newBSMultiDateRange:function(params){if(!params){params={}}edges.bs3.BSMultiDateRange.prototype=edges.newRenderer(params);return new edges.bs3.BSMultiDateRange(params)},BSMultiDateRange:function(params){this.dateFormat=edges.getParam(params.dateFormat,"MMMM D, YYYY");this.useSelect2=edges.getParam(params.useSelect2,false);this.ranges=edges.getParam(params.ranges,false);this.dre=false;this.selectId=false;this.rangeId=false;this.selectJq=false;this.rangeJq=false;this.drp=false;this.namespace="edges-bs3-bs-multi-date-range";this.draw=function(){var dre=this.component;var selectClass=edges.css_classes(this.namespace,"select",this);var inputClass=edges.css_classes(this.namespace,"input",this);var prefixClass=edges.css_classes(this.namespace,"prefix",this);this.selectId=edges.css_id(this.namespace,dre.id+"_date-type",this);this.rangeId=edges.css_id(this.namespace,dre.id+"_range",this);var pluginId=edges.css_id(this.namespace,dre.id+"_plugin",this);var options="";for(var i=0;i<dre.fields.length;i++){var field=dre.fields[i];var selected=dre.currentField==field.field?' selected="selected" ':"";options+='<option value="'+field.field+'"'+selected+">"+field.display+"</option>"}var frag='<div class="form-inline">';if(dre.display){frag+='<span class="'+prefixClass+'">'+dre.display+"</span>"}frag+='<div class="form-group"><select class="'+selectClass+' form-control" name="'+this.selectId+'" id="'+this.selectId+'">'+options+"</select></div>";frag+='<div id="'+this.rangeId+'" class="'+inputClass+' form-control">                    <i class="glyphicon glyphicon-calendar"></i>&nbsp;                    <span></span> <b class="caret"></b>                </div>';frag+="</div>";dre.context.html(frag);var selectIdSelector=edges.css_id_selector(this.namespace,dre.id+"_date-type",this);var rangeIdSelector=edges.css_id_selector(this.namespace,dre.id+"_range",this);this.selectJq=dre.jq(selectIdSelector);this.rangeJq=dre.jq(rangeIdSelector);var cb=edges.objClosure(this,"updateDateRange",["start","end"]);var props={locale:{format:"DD/MM/YYYY"},opens:"left"};if(this.ranges){props["ranges"]=this.ranges}var pluginSelector=edges.css_id_selector(this.namespace,dre.id+"_plugin",this);$(pluginSelector).remove();this.rangeJq.daterangepicker(props,cb);this.drp=this.rangeJq.data("daterangepicker");this.drp.container.attr("id",pluginId).addClass("show-calendar");this.prepDates();if(this.useSelect2){this.selectJq.select2()}edges.on(selectIdSelector,"change",this,"typeChanged")};this.dateRangeDisplay=function(params){var start=params.start;var end=params.end;this.rangeJq.find("span").html(start.utc().format(this.dateFormat)+" - "+end.utc().format(this.dateFormat))};this.updateDateRange=function(params){var start=params.start;var end=params.end;var date_type=null;if(this.useSelect2){date_type=this.selectJq.select2("val")}else{date_type=this.selectJq.val()}this.component.changeField(date_type);this.component.setFrom(start.toDate());this.component.setTo(end.toDate());this.dateRangeDisplay(params);var triggered=this.component.triggerSearch();if(!triggered){this.prepDates()}};this.typeChanged=function(element){var date_type=null;if(this.useSelect2){date_type=this.selectJq.select2("val")}else{date_type=this.selectJq.val()}this.component.changeField(date_type);this.component.setFrom(false);this.component.setTo(false);var triggered=this.component.triggerSearch();if(!triggered){this.prepDates()}};this.prepDates=function(){var min=this.component.currentEarliest();var max=this.component.currentLatest();var fr=this.component.fromDate;var to=this.component.toDate;if(min){this.drp.minDate=moment(min);this.drp.setStartDate(moment(min))}else{this.drp.minDate=moment(this.component.defaultEarliest);this.drp.setStartDate(moment(this.component.defaultEarliest))}if(max){this.drp.maxDate=moment(max);this.drp.setEndDate(moment(max))}else{this.drp.maxDate=moment(this.component.defaultLatest);this.drp.setEndDate(moment(this.component.defaultLatest))}if(fr){if(fr<this.drp.minDate){this.drp.minDate=moment(fr)}if(fr>this.drp.maxDate){this.drp.maxDate=moment(fr)}this.drp.setStartDate(moment(fr))}if(to){if(to<this.drp.minDate){this.drp.minDate=moment(to)}if(to>this.drp.maxDate){this.drp.maxDate=moment(to)}this.drp.setEndDate(moment(to))}this.dateRangeDisplay({start:this.drp.startDate,end:this.drp.endDate})}}}});$.extend(true,edges,{bs3:{newSearchingNotificationRenderer:function(params){if(!params){params={}}edges.bs3.SearchingNotificationRenderer.prototype=edges.newRenderer(params);return new edges.bs3.SearchingNotificationRenderer(params)},SearchingNotificationRenderer:function(params){this.searchingMessage=params.searchingMessage||"Loading, please wait...";this.namespace="edges-bs3-searching-notification";this.draw=function(){var frag="";if(this.component.searching){var barClasses=edges.css_classes(this.namespace,"bar",this);frag='<div class="progress-bar progress-bar-info progress-bar-striped active '+barClasses+'">                             '+this.searchingMessage+"                         </div>"}this.component.context.html(frag)}}}});$.extend(muk,{funder:{newFunderReportTemplate:function(params){if(!params){params={}}muk.funder.FunderReportTemplate.prototype=edges.newTemplate(params);return new muk.funder.FunderReportTemplate(params)},FunderReportTemplate:function(params){this.edge=false;this.hidden={};this.tabIds=[];this.namespace="muk-funder-report-template";this.draw=function(edge){this.edge=edge;var intro="See the amount of APCs, total APC expenditure, or average APC cost for several funders for a given period. Filter by institution or journal type. Use this report to:                <ul>                    <li>Compare number of APCs funded by funders</li>                    <li>See funding expenditure for a specific institution</li>                    <li>Break down how funds are spent by journal type</li>                </ul>";var panelClass=edges.css_classes(this.namespace,"panel");var topClass=edges.css_classes(this.namespace,"top");var filtersClass=edges.css_classes(this.namespace,"filters");var filterClass=edges.css_classes(this.namespace,"filter");var tabViewClass=edges.css_classes(this.namespace,"tabview");var tabContainerClass=edges.css_classes(this.namespace,"tab-container");var tabLabelBarClass=edges.css_classes(this.namespace,"tab-bar");var tabClass=edges.css_classes(this.namespace,"tab");var storyClass=edges.css_classes(this.namespace,"stories");var dataClass=edges.css_classes(this.namespace,"data");var filterHeaderClass=edges.css_classes(this.namespace,"filter-header");var pieClass=edges.css_classes(this.namespace,"uk_pie");var pieId=edges.css_id(this.namespace,"uk_pie");var pieChartClass=edges.css_classes(this.namespace,"uk_pie_chart");var pieChartId=edges.css_id(this.namespace,"uk_pie_chart");var pieTableClass=edges.css_classes(this.namespace,"uk_pie_table");var pieTableId=edges.css_id(this.namespace,"uk_pie_table");var loading=edge.category("loading");var loadContainers="";if(loading.length>0){for(var i=0;i<loading.length;i++){loadContainers+='<div class="row"><div class="col-md-12"><div id="'+loading[i].id+'"></div></div></div>'}}var topstrap=edge.category("top-right");var topContainers="";if(topstrap.length>0){for(var i=0;i<topstrap.length;i++){topContainers+='<div class="row"><div class="col-md-12"><div id="'+topstrap[i].id+'"></div></div></div>'}}topContainers='<div class="row"><div class="col-md-8 report-intro-text">'+intro+'</div><div class="col-md-4">'+topContainers+"</div></div>";var lhs=edge.category("lhs");var controlContainers="";for(var i=0;i<lhs.length;i++){controlContainers+='<div class="'+filterClass+'" id="'+lhs[i].id+'"></div>'}var tabs=edge.category("tab");var tabLabels="";var tabContents="";for(var i=0;i<tabs.length;i++){var tab=tabs[i];var containerId=edges.css_id(this.namespace,"tab-"+tab.id);var linkId=edges.css_id(this.namespace,"link-"+tab.id);this.tabIds.push(tab.id);tabLabels+='<li><a href="#" id="'+linkId+'" data-id="'+tab.id+'">'+tab.display+"</a></li>";tabContents+='<div class="'+tabContainerClass+'" id="'+containerId+'">                            <div class="row">                                <div class="col-md-12">                                     <div class="'+tabClass+'" id="'+tab.id+'"></div>                                </div>                             </div>                        </div>'}tabLabels='Show:&nbsp;&nbsp;<ul class="nav nav-tabs navbar-right">'+tabLabels+"</ul>";var stories=edge.category("story");var storyContainers="";if(stories.length>0){for(var i=0;i<stories.length;i++){storyContainers+='<div class="row"><div class="col-md-12"><div id="'+stories[i].id+'"></div></div></div>'}}var pieContents='                <h3>UK Pure OA/Hybrid breakdown</h3>                <div class="'+pieChartClass+'" id="'+pieChartId+'"></div>                <div class="'+pieTableClass+'" id="'+pieTableId+'"></div>';var data=edge.category("data");var dataContainers="";if(data.length>0){for(var i=0;i<data.length;i++){dataContainers+='<div class="row"><div class="col-md-12"><div id="'+data[i].id+'"></div></div></div>'}}var filterHeader='<div class="'+filterHeaderClass+'"><div class="row"><div class="col-md-12"><span class="glyphicon glyphicon-filter"></span>&nbsp;FILTER</div></div></div>';var template='<div class="'+panelClass+'">                    <div class="'+topClass+'">'+topContainers+'</div>                    <div class="row">                        <div class="col-md-3">                            <div class="'+filtersClass+'">'+filterHeader+controlContainers+'</div>                        </div>                        <div class="col-md-9">                            <div class="'+tabViewClass+'">                                <div class="'+tabLabelBarClass+'"><div class="row"><div class="col-md-12">'+tabLabels+"</div></div></div>                                "+tabContents+'                            </div>                        </div>                    </div>                    <div class="row">                        <div class="col-md-7">                            <div class="'+storyClass+'">'+storyContainers+'</div>                            <hr>                            <div class="'+dataClass+'">'+dataContainers+'</div>                        </div>                        <div class="col-md-5 '+pieClass+'" id="'+pieId+'">'+pieContents+"</div>                    </div>                </div>";edge.context.html(template);for(var i=0;i<this.tabIds.length;i++){var tabSelector=edges.css_id_selector(this.namespace,"tab-"+this.tabIds[i]);this.hideOffScreen(tabSelector)}var startWith=this.tabIds[0];this.activateTab(startWith);for(var i=0;i<this.tabIds.length;i++){var linkSelector=edges.css_id_selector(this.namespace,"link-"+this.tabIds[i]);edges.on(linkSelector,"click",this,"tabClicked")}};this.hideOffScreen=function(selector){if(selector in this.hidden){return}var el=this.edge.jq(selector);this.hidden[selector]={position:el.css("position"),margin:el.css("margin-left")};el.css("position","absolute").css("margin-left",-9999)};this.bringIn=function(selector){if(!this.hidden[selector]){return}var pos=this.hidden[selector].position;var mar=this.hidden[selector].margin;var el=this.edge.jq(selector);el.css("position",pos).css("margin-left",mar);delete this.hidden[selector]};this.activateTab=function(activate){var tabs=this.edge.category("tab");for(var i=0;i<tabs.length;i++){var tab=tabs[i];var tabSelector=edges.css_id_selector(this.namespace,"tab-"+tab.id);var linkSelector=edges.css_id_selector(this.namespace,"link-"+tab.id);if(tab.id===activate){this.bringIn(tabSelector);this.edge.jq(linkSelector).parent().addClass("active")}else{this.hideOffScreen(tabSelector);this.edge.jq(linkSelector).parent().removeClass("active")}}};this.tabClicked=function(element){var id=$(element).attr("data-id");this.activateTab(id)}},chartColours:["#66bdbe","#a6d6d6","#7867a3","#d90d4c","#6bcf65"],valueMap:{oa:"Pure OA",hybrid:"Hybrid",unknown:"Unknown"},newStory:function(params){if(!params){params={}}muk.funder.Story.prototype=edges.newComponent(params);return new muk.funder.Story(params)},Story:function(params){this.avgCount=false;this.avgExp=false;this.avgAPC=false;this.synchronise=function(){this.avgCount=false;this.avgExp=false;this.avgAPC=false;var results=this.edge.secondaryResults.uk_mean;var stats=results.aggregation("total_stats");var pubs=results.aggregation("funder_count");this.avgCount=stats.count/pubs.value;this.avgExp=stats.sum/pubs.value;this.avgAPC=stats.avg};this.draw=function(){if(!this.avgCount||!this.avgExp||!this.avgAPC){this.context.html("");return}var story="<p>On average, a funder pays for <strong>{{x}}</strong> APC payments in this period, with the average total expenditure on them being <strong>£{{y}}</strong> and the average UK APC cost being <strong>£{{z}}</strong></p>";story=story.replace(/{{x}}/g,Number(this.avgCount.toFixed(0)).toLocaleString()).replace(/{{y}}/g,Number(this.avgExp.toFixed(0)).toLocaleString()).replace(/{{z}}/g,Number(this.avgAPC.toFixed(0)).toLocaleString());this.context.html(story)}},storyQuery:function(edge){var query=edge.cloneQuery();query.removeMust(es.newTermsFilter({field:"record.rioxxterms:project.funder_name.exact"}));query.clearAggregations();query.addAggregation(es.newStatsAggregation({name:"total_stats",field:"index.amount_inc_vat"}));query.addAggregation(es.newCardinalityAggregation({name:"funder_count",field:"record.rioxxterms:project.funder_name.exact"}));query.size=0;query.from=0;return query},reportDF:function(params){var ch=params.chart;var valueFunction=params.valueFunction;var data_series=[];if(!ch.edge.result){return data_series}var fund_filters=ch.edge.currentQuery.listMust(es.newTermsFilter({field:"record.rioxxterms:project.funder_name.exact"}));var oahyb_buckets=ch.edge.result.buckets("oahybrid");for(var k=0;k<oahyb_buckets.length;k++){var obucket=oahyb_buckets[k];var okey=obucket.key;var series={};series["key"]=muk.funder.valueMap[okey];series["values"]=[];var fund_buckets=obucket["funder"].buckets;for(var l=0;l<fund_buckets.length;l++){var fbucket=fund_buckets[l];var fkey=fbucket.key;var skip=false;for(var j=0;j<fund_filters.length;j++){var filt=fund_filters[j];if(!filt.has_term(fkey)){skip=true;break}}if(skip){continue}var value=valueFunction(fbucket);series["values"].push({label:fkey,value:value})}data_series.push(series)}return muk.funder.stackedBarClean(data_series,fund_filters.length===0)},stackedBarClean:function(data_series,splice_for_brevity){var labels=[];var i=data_series.length;while(i--){var s=data_series[i];if(!s.values.length){data_series.splice(i,1)}else{for(var j=0;j<s.values.length;j++){var label=s.values[j].label;if($.inArray(label,labels)==-1){labels.push(label)}}}}var sorted_labels=splice_for_brevity?labels.splice(0,10).sort():labels.sort();var clean_series=[];for(var a=0;a<data_series.length;a++){var k=data_series[a].key;var vs=data_series[a].values;var cs={};cs["key"]=k;cs["values"]=[];for(var b=0;b<sorted_labels.length;b++){var l=sorted_labels[b];var current_labels_value=undefined;for(var c=0;c<vs.length;c++){if(vs[c].label==l){current_labels_value={label:l,value:vs[c].value,series:a,key:k}}}if(current_labels_value===undefined){cs["values"].push({label:l,value:0,series:a,key:k})}else{cs["values"].push(current_labels_value)}}clean_series.push(cs)}return clean_series},apcCountDF:function(ch){return muk.funder.reportDF({chart:ch,valueFunction:function(bucket){return bucket.doc_count}})},apcExpenditureDF:function(ch){return muk.funder.reportDF({chart:ch,valueFunction:function(bucket){return bucket.funder_stats.sum}})},avgAPCDF:function(ch){return muk.funder.reportDF({chart:ch,valueFunction:function(bucket){return bucket.funder_stats.avg}})},tableData:function(charts){var seriesNames={apc_count:"APC Count",total_expenditure:"Total expenditure",mean:"Average APC cost"};var formatter=muk.toIntFormat();var rows={};for(var i=0;i<charts.length;i++){var chart=charts[i];if(!chart.dataSeries){continue}var dataSeries=chart.dataSeries;for(var j=0;j<dataSeries.length;j++){var ds=dataSeries[j];var inst=ds.key;for(var k=0;k<ds.values.length;k++){var val=ds.values[k];var pub=val.label;var num=val.value;var rowId=pub+" - "+seriesNames[chart.id];var row={};if(rowId in rows){row=rows[rowId]}row[inst]=formatter(num);rows[rowId]=row}}}var rowNames=Object.keys(rows);rowNames.sort();var table=[];for(var i=0;i<rowNames.length;i++){var obj=rows[rowNames[i]];obj["Metric"]=rowNames[i];table.push(obj)}return table},pieDF:function(ch){var buckets=ch.edge.result.data.aggregations["oavshybrid"].buckets;var series={};series["key"]="oavshybrid";series["values"]=[];for(var j=0;j<buckets.length;j++){var doccount=buckets[j].doc_count;var key=buckets[j].key;series.values.push({label:muk.funder.valueMap[key],value:doccount})}return[series]},pieTable:function(charts){var ds=charts[0].dataSeries[0].values;var total=charts[0].edge.result.data.hits.total;for(var x=0;x<ds.length;x++){ds[x]["percent"]=(100*(ds[x].value/total)).toFixed(2)}return ds},makeFunderReport:function(params){if(!params){params={}}var check_query=es.newQuery({size:0});check_query.addMust(es.newTermsFilter({field:"record.jm:apc.organisation_name.exact",values:[myInstituion]}));es.doQuery({search_url:octopus.config.public_query_endpoint,queryobj:check_query.objectify(),success:function(result){if(result.total()==0){myInstituion=false}muk.funder.makeFunderReport2(params)},error:function(){myInstituion=false;muk.funder.makeFunderReport2(params)}})},makeFunderReport2:function(params){if(!params){params={}}var selector=edges.getParam(params.selector,"#muk_funder");var base_query=es.newQuery({size:0});base_query.addAggregation(es.newTermsAggregation({name:"oahybrid",field:"record.dc:source.oa_type.exact",size:0,aggs:[es.newTermsAggregation({name:"funder",field:"record.rioxxterms:project.funder_name.exact",size:1e4,aggs:[es.newStatsAggregation({name:"funder_stats",field:"index.amount_inc_vat"})]})]}));var opening_query=es.newQuery();if(myInstituion&&myInstituion!=""){opening_query.addMust(es.newTermsFilter({field:"record.jm:apc.organisation_name.exact",values:[myInstituion]}))}var e=edges.newEdge({selector:selector,template:muk.funder.newFunderReportTemplate(),search_url:octopus.config.public_query_endpoint,baseQuery:base_query,openingQuery:opening_query,secondaryQueries:{uk_mean:muk.funder.storyQuery},components:[edges.newMultiDateRangeEntry({id:"date_range",display:"REPORT PERIOD:<br>",fields:[{field:"record.rioxxterms:publication_date",display:"Publication Date"},{field:"record.jm:apc.date_applied",display:"APC Application"},{field:"record.jm:apc.date_paid",display:"APC Paid"}],autoLookupRange:true,category:"top-right",renderer:edges.bs3.newBSMultiDateRange({ranges:muk.yearRanges({"academic year":"09-01","fiscal year":"04-01","calendar year":"01-01"},{"This ":0,"Last ":1})})}),edges.newORTermSelector({id:"institution",field:"record.jm:apc.organisation_name.exact",display:"Institution",lifecycle:"update",size:1e4,category:"lhs",orderBy:"count",orderDir:"desc",renderer:edges.bs3.newORTermSelectorRenderer({open:true,togglable:false,showCount:true,hideEmpty:true})}),edges.newORTermSelector({id:"funder",field:"record.rioxxterms:project.funder_name.exact",display:"Funder",lifecycle:"update",size:1e4,category:"lhs",renderer:edges.bs3.newORTermSelectorRenderer({open:true,togglable:false,showCount:true,hideEmpty:true})}),edges.newORTermSelector({id:"oa_type",field:"record.dc:source.oa_type.exact",display:"Journal type",lifecycle:"update",category:"lhs",orderBy:"count",orderDir:"desc",valueMap:muk.funder.valueMap,renderer:edges.bs3.newORTermSelectorRenderer({open:true,togglable:false,showCount:true,hideEmpty:true})}),edges.newHorizontalMultibar({id:"apc_count",display:"Number of APCs",dataFunction:muk.funder.apcCountDF,category:"tab",renderer:edges.nvd3.newHorizontalMultibarRenderer({noDataMessage:"No data to display",showValues:true,controls:true,stacked:true,color:muk.funder.chartColours,valueFormat:muk.toIntFormat(),yAxisLabel:"Number of APCs"})}),edges.newHorizontalMultibar({id:"total_expenditure",display:"Total expenditure",dataFunction:muk.funder.apcExpenditureDF,category:"tab",renderer:edges.nvd3.newHorizontalMultibarRenderer({noDataMessage:"No data to display",showValues:true,controls:true,stacked:true,color:muk.funder.chartColours,valueFormat:muk.toGBPIntFormat(),yTickFormat:muk.toGBPIntFormat(),yAxisLabel:"Total expenditure"})}),edges.newHorizontalMultibar({id:"mean",display:"Average APC Cost",dataFunction:muk.funder.avgAPCDF,category:"tab",renderer:edges.nvd3.newHorizontalMultibarRenderer({noDataMessage:"No data to display",showValues:true,controls:true,stacked:true,color:muk.funder.chartColours,valueFormat:muk.toGBPIntFormat(),yTickFormat:muk.toGBPIntFormat(),yAxisLabel:"Average APC Cost"})}),muk.funder.newStory({id:"story",category:"story"}),edges.newChartsTable({id:"data_table",display:"Raw Data",category:"data",chartComponents:["apc_count","total_expenditure","mean"],tabularise:muk.funder.tableData,renderer:edges.bs3.newTabularResultsRenderer({fieldDisplay:[{field:"Metric",display:"Funder"}],displayListedOnly:false,download:true,downloadText:"download as csv"})})]});muk.activeEdges[selector]=e;var oavshybrid_uk_query=es.newQuery();oavshybrid_uk_query.addAggregation(es.newTermsAggregation({name:"oavshybrid",field:"record.dc:source.oa_type.exact"}));var e2=edges.newEdge({selector:edges.css_id_selector("muk-funder-report-template","uk_pie"),search_url:octopus.config.public_query_endpoint,baseQuery:oavshybrid_uk_query,components:[edges.newPieChart({id:edges.css_id("muk-funder-report-template","uk_pie_chart"),dataFunction:muk.funder.pieDF,renderer:edges.nvd3.newPieChartRenderer({valueFormat:d3.format(",d"),labelsOutside:true,color:muk.funder.chartColours})}),edges.newChartsTable({id:edges.css_id("muk-funder-report-template","uk_pie_table"),display:"Raw Data",chartComponents:[edges.css_id("muk-funder-report-template","uk_pie_chart")],tabularise:muk.funder.pieTable,renderer:edges.bs3.newTabularResultsRenderer({fieldDisplay:[{field:"label",display:""},{field:"value",display:"Total"},{field:"percent",display:"%"}],download:false})})]});muk.activeEdges["#uk_pie"]=e2}}});
