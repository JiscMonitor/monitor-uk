    ...
    funder: {
        ...
        FunderReportTemplate: function(params) {
            ...
            this.draw = function(edge) {
                ...
                var pieContents = '                <h3>UK Pure OA/Hybrid breakdown</h3>                <div class="' + pieChartClass + '" id="' + pieChartId + '"></div>                <div class="' + pieTableClass + '" id="' + pieTableId + '"></div>';
                ...
                var template = '<div class="' + panelClass + '">                    <div class="' + topClass + '">' + topContainers + '</div>                    <div class="row">                        <div class="col-md-3">                            <div class="' + filtersClass + '">' + filterHeader + controlContainers + '</div>                        </div>                        <div class="col-md-9">                            <div class="' + tabViewClass + '">                                <div class="' + tabLabelBarClass + '"><div class="row"><div class="col-md-12">' + tabLabels + "</div></div></div>                                " + tabContents + '                            </div>                        </div>                    </div>                    <div class="row">                        <div class="col-md-7">                            <div class="' + storyClass + '">' + storyContainers + '</div>                            <hr>                            <div class="' + dataClass + '">' + dataContainers + '</div>                        </div>                        <div class="col-md-5 ' + pieClass + '" id="' + pieId + '">' + pieContents + "</div>                    </div>                </div>";
        ...
        reportDF: function(params) {
            ...
            var fund_filters = ch.edge.currentQuery.listMust(es.newTermsFilter({
                field: "record.rioxxterms:project.funder_name.exact"
            }));
        ...
        apcExpenditureDF: function(ch) {
            return muk.funder.reportDF({
                chart: ch,
                valueFunction: function(bucket) {
                    return bucket.funder_stats.sum
                }
            })
        },
        avgAPCDF: function(ch) {
            return muk.funder.reportDF({
                chart: ch,
                valueFunction: function(bucket) {
                    return bucket.funder_stats.avg
                }
            })
        },
        ...
        pieTable: function(charts) {
            var ds = charts[0].dataSeries[0].values;
        ...
        makeFunderReport2: function(params) {
            ...
            oavshybrid_uk_query.addAggregation(es.newTermsAggregation({
                name: "oavshybrid",
                field: "record.dc:source.oa_type.exact"
            }));
